...
class SetupDefaultTemplates extends Command
{
    ...
    {
        $templates = [
            ['template_type' => 'welcome', 'subject' => 'Bienvenue sur {{ site_name }} !', 'html_body' => '<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px"><h1 style="color:#6366f1">Bienvenue {{ first_name }} !</h1><p>Votre compte <strong>{{ username }}</strong> a été créé avec succès sur {{ site_name }}.</p><p>Connectez-vous dès maintenant pour profiter de votre musique.</p><a href="{{ site_url }}/login" style="display:inline-block;background:#6366f1;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;margin-top:10px">Se connecter</a></div>'],
