...
<body class="bg-zinc-950 text-zinc-100 min-h-screen flex">
    <aside class="w-56 border-r min-h-screen p-3 flex flex-col gap-0.5 text-sm flex-shrink-0" style="background:rgba(7,8,16,.9);border-color:rgba(255,255,255,.07);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px)">
        ...
        <a href="/admin/settings/stripe" class="text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800/50 px-3 py-2 rounded-lg flex items-center gap-2 {{ request()->is('admin/settings/stripe*') ? 'text-indigo-300 bg-indigo-500/10' : '' }}">Intégration Stripe</a>
        ...
        <a href="/admin/settings/restoration-fee" class="text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800/50 px-3 py-2 rounded-lg flex items-center gap-2 {{ request()->is('admin/settings/restoration-fee*') ? 'text-indigo-300 bg-indigo-500/10' : '' }}">Frais de restauration</a>
